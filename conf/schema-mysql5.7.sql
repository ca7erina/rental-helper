...
create table matching_info (
  ...
  created_date              timestamp DEFAULT  '1970-01-01 00:00:01',
  updated_date              timestamp DEFAULT  '1970-01-01 00:00:01',
  active                    boolean,
  user_id                   bigint,
...
create table token (
  ...
  user_id                   bigint,
  type                      varchar(8),
  date_creation             timestamp DEFAULT  '1970-01-01 00:00:01',
  email                     varchar(255),
